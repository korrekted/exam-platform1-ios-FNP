            ...
            VStack(alignment: .leading) {
                VStack(alignment: .center) {
                    PassRateView(title: "Widgets.PassRate".localized,
                                 ...
                                 titleColor: Color(red: 76 / 255, green: 99 / 255, blue: 130 / 255),
                    ...
                    HStack() {
                        MediumVerticalRateView(count: entry.testsTakenNum,
                                               ...
                                               color: Color(red: 76 / 255, green: 99 / 255, blue: 130 / 255))
                        Spacer()
                        ...
                        MediumVerticalRateView(count: entry.answeredQuestions,
                                               ...
                                               color: Color(red: 226 / 255, green: 114 / 255, blue: 75 / 255))
                    }
                }
                .padding(16)
            }
